...
char staffID[10], staffPW[20], PIN[255], studentDetails[][5][60] = { {"KPKL1234","idk","20","July","November"},{""} };studSem1Sub[][13][8] = { {"AAA1003","AAA1014","AAA1013","AAA1024","AAA1024","AAA1052"}}, studSem2Sub[][13][8]={ {"AAA1103","AAA1114","AAA1113","AAA1124","AAA1124","AAA1152"} }, studSem3Sub[][13][8]= { {"AAA1203","AAA1214","AAA1213","AAA1224","AAA1224","AAA1252"} };
...
char adminMenu() {
	...
	int select, subSelect, i, loop = 1, loop2 = 1, menu2select, subjectLoop, ID, semSelect, gradeLoop = 1;
	char IDcheck[10], grade[2];
	while (loop == 1) {
